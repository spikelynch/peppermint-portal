...
export class TranslationService {
  ...
  constructor (protected translateI18Next: TranslateI18Next, protected location: Location) {
    this.subjects = {};
    this.initTranslator();
  }
  ...
  initTranslator() {
    ...
    this.translateI18Next.init({
        ...
        lng: 'en',
        fallbackLng: 'en',
        backend: { loadPath: this.location.prepareExternalUrl(`assets/locales/{{lng}}/{{ns}}.json?ts=${ts}`) }
    }).then(() => {
